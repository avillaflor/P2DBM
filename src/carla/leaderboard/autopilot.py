# Taken from https://github.com/autonomousvision/plant with minor modifications for targeting speed limit
import os
import json
import gzip
import time
...
class AutoPilot(autonomous_agent_local.AutonomousAgent):
    def setup(self, path_to_conf_file, route_index=None, cfg=None, exec_or_inter=None):
        ...
        self._turn_controller = PIDController(K_P=1., K_I=0., K_D=0.3, n=20)
        self._turn_controller_extrapolation = PIDController(K_P=1., K_I=0., K_D=0.3, n=20)
    ...
    def _get_control(self, input_data, steer=None, throttle=None,
        ...
        # CHANGED to make autopilot target speed limit
        target_speed = self._vehicle.get_speed_limit() / 3.6
