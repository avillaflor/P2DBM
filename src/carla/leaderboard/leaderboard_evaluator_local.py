# Taken from https://github.com/autonomousvision/plant
#!/usr/bin/env python
...
from src.carla.leaderboard.agent_wrapper_local import AgentWrapper, AgentError
...
sensors_to_icons = {
    ...
    'sensor.camera.semantic_segmentation':  'carla_camera', # CHANGED
}
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            ...
            if int(os.environ['DATAGEN'])==1:
                self.agent_instance = getattr(self.module_agent, agent_class_name)(args.agent_config, config.index, args) # CHANGED
            else:
                self.agent_instance = getattr(self.module_agent, agent_class_name)(args.agent_config, route_date_string, args) # CHANGED
