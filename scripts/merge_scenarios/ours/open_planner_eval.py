...
from src.models.open_planner import OpenPlanner
...
def main(cfg):
    ...
    try:
        for ep in tqdm(range(num_episodes)):
            ...
            if cfg.save_gif:
                if len(ims) > 0:
                    save_dir = os.path.join(cfg.logging_dir, 'open_planner_viz')
        ...
        eval_save_dir = os.path.join(cfg.logging_dir, 'open_planner_eval')
