# Taken from https://github.com/autonomousvision/plant with minor changes
import argparse
import os
import sys
import hydra
...
def main(cfg):
    ...
    sys.path.append(f"{cfg_org.user.plant_dir}/leaderboard")
    sys.path.append(f"{cfg_org.user.plant_dir}/scenario_runner")
    sys.path.append(f"{cfg_org.user.plant_dir}")

    if ("CARLA_9_10_PATH" in os.environ) and ("CARLA_9_10_PYTHONPATH" in os.environ):
    ...
    from src.carla.leaderboard import leaderboard_evaluator_local
